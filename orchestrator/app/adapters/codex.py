...
Boundary only: Codex is **not connected** in Phase 4.  Health reports
...
class CodexAdapter(AgentAdapter):
    """Adapter for the ``codex`` provider (boundary only in Phase 4)."""
    ...
    def check_health(self, agent_id: uuid.UUID) -> AgentHealth:
        return AgentHealth(
            ...
            detail=("codex provider is not configured: Codex integration lands in a later phase."),
